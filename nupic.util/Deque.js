...
console.log(this.backingList);
    ...
    hashCode: function() { // int(void)
        var prime = 31;
        var result = 1;
        result = prime * result + (util.isNullOrUndefined(this.backingList) ? 0 : this.backingList.hashCode());
    ...
    equals: function(obj) { // boolean(Object)
        ...
        if (util.isNullOrUndefined(this.backingLis)) {
            if (!util.isNullOrUndefined(other.backingList)) {
                return false;
            }
