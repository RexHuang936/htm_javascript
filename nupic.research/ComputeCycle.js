...
var ComputeCycle = function() {
    ...
    var ComputeCycle_non_void = function(c) {
        ...
        that.activeSynapsesForSegment = util.copyOf(c.getActiveSynapsesForSegment(), "map"); // new LinkedHashMap<DistalDendrite, Set<Synapse>>(c.getActiveSynapsesForSegment());
    };
